...
def validate_writable_paths() -> None:
    """
    Validate that STATE_DIR is writable.
...
# Rate limiting API — i limiti per singolo endpoint sono configurati direttamente
# in enforce_rate_limit() nelle API routes. Le variabili ENV RATE_LIMIT_REQUESTS
# e RATE_LIMIT_WINDOW_SECONDS sono lette da app/core/rate_limit.py.
