...
def test_text_export_utils_file_exists():
    ...
    for func_name in required_functions:
        assert f"function {func_name}" in content or f"const {func_name}" in content or f"export" in content, \
...
def test_copy_to_clipboard_implementation():
    ...
    assert "navigator.clipboard" in content or "clipboard" in content.lower(), \
...
def test_download_text_file_implementation():
    ...
    assert "download" in content.lower(), \
        "downloadTextFile should trigger file download"
...
def test_download_binary_file_implementation():
    ...
    assert "download" in content.lower(), \
        "downloadBinaryFile should trigger file download"
...
def test_revert_panel_uses_export_utils():
    ...
    for component_name in components:
        ...
        assert "Download" in content or "download" in content.lower(), \
